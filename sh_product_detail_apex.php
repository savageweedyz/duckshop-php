...
<div class="container-fluid"> <!-- Include the sidebar from menu11.php -->
  ...
  <img src="image/apexcoin.png" class="card-img-top" alt="rateterm">
  <div class="card-body">
    ...
    <form>
        <select class="form-select" aria-label="Default select example">
            ...
            <option value="1">1000 Apex Coin 300 บาท</option>
            <option value="2">2150 Apex Coin 600 บาท</option>
            <option value="3">4350 Apex Coin 1000 บาท</option>
            <option value="4">6700 Apex Coin 1700 บาท</option>
            <option value="5">11500 Apex Coin 3260 บาท</option>
