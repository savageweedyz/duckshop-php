...
<a href="../jectjeng/index.php" class="text-center">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
      <li class="nav-item">
        <a href="index_ad.php" class="nav-link text-white" aria-current="page">
          <svg class="bi pe-none me-2" width="16" height="16"><use xlink:href="#home"></use></svg>
      ...
      <li>
        <a href="refill.php" class="nav-link text-white">
      ...
      <li>
        <a href="game.php" class="nav-link text-white">
      ...
      <li>
        <a href="gift.php" class="nav-link text-white">
      ...
      <li>
        <a href="fr_product.php" class="nav-link text-white">
          <svg class="bi pe-none me-2" width="16" height="16"><use xlink:href="#grid"></use></svg>
          <img src="../image/plus.png" style="width:auto; height: 30px;"href="index.php/jectjeng/index.php">
          เพิ่มสินค้า
        </a>
      </li>
      <li>
        <a href="report_order.php" class="nav-link text-white">
          <svg class="bi pe-none me-2" width="16" height="16"><use xlink:href="#grid"></use></svg>
          <img src="../image/bill.png" style="width:auto; height: 30px;"href="index.php/jectjeng/index.php">
