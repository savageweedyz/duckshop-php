...
<div class="container-fluid"> <!-- Include the sidebar from menu11.php -->
  ...
  <img src="image/uc.png" class="card-img-top" alt="rateterm">
  <div class="card-body">
    ...
    <form>
        <select class="form-select" aria-label="Default select example">
            ...
            <option value="1">60 UC 35 บาท</option>
            <option value="2">325 UC 175 บาท</option>
            <option value="3">660 UC 350 บาท</option>
            <option value="4">1800 UC 850 บาท</option>
            <option value="5">3850 UC 1700 บาท</option>
            <option value="6">8100 UC 3400 บาท</option>
