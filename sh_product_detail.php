...
<div class="container-fluid"> <!-- Include the sidebar from menu11.php -->
  ...
  <img src="image/pg.png" class="card-img-top" alt="rateterm">
  <div class="card-body">
    ...
    <form>
        <select class="form-select" aria-label="Default select example">
            ...
            <option value="1">แพ็คพรแห่งดวงจันทร์ 149 บาท</option>
            <option value="2">60 Primogem 35 บาท</option>
            <option value="3">300 Primogem 150 บาท</option>
            <option value="4">980 Primogem 435 บาท</option>
            <option value="5">1980 Primogem 895 บาท</option>
            <option value="6">3280 Primogem 1,395 บาท</option>
            <option value="7">6480 Primogem 2,645 บาท</option>
